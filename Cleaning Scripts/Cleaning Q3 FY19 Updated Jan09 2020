...
--Added t_hddfixes that were found in Q2, may also need to update for Q3
...
--Added t_hddfixes that were found in Q3, may also need to update for Q4
...
--Added to fix the district information for Q3
update t_hdd set Distrito = 'Chibuto' where designacao like 'CS Maqueze'
